window.meboxInfo = {
  ...
  upload: {
    ...
    fileSizeTooLarge: "单个文件的大小不应超过100MB",
...
window.meboxToaster = function meboxToaster(options) {
  ...
  var newToast = function(i) {
    ...
    if (type === 1) {
      toaster = $('<div class="toaster"><p class="toaster-content success">' +
        '<i class="icon fa fa-check-circle-o"></i>' + toasterMessages[i].content + '</p></div>');
    } else if (type === 2) {
      toaster = $('<div class="toaster"><p class="toaster-content error">' +
        '<i class="icon fa fa-close"></i>' + toasterMessages[i].content + '</p></div>');
    } else {
      toaster = $('<div class="toaster"><p class="toaster-content warning">' +
        '<i class="icon fa fa-exclamation"></i>' + toasterMessages[i].content + '</p></div>');
    }
...
// 服务器错误反馈
window.serverErrorToaster = function serverErrorToaster() {
  meboxToaster({
    message: [{
      type: 2,
